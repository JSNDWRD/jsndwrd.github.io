      ...
      <main className="bg-primary flex text-text mt-20">
        ...
        <section className="h-[calc(100vh-5rem)] basis-1/3 flex flex-col">
          <div className="p-4 pl-12 fixed w-1/3 font-medium">
            ...
            <h1 className="text-8xl font-bebasneue leading-[.8]">Jason Edward Salim</h1>
            ...
            <div className="flex flex-wrap gap-4 items-center">
              ...
              <a href="https://www.instagram.com/jsndwrd" target="_blank">
                <FaInstagram size={35} className="hover:fill-blue-600 fill-text hover:scale-125 transition-all" />
              </a>
              <a href="https://www.twitter.com/jsndwrd" target="_blank">
                <FaTwitter size={35} className="hover:fill-blue-600 fill-text hover:scale-125 transition-all" />
              </a>
              <a href="https://www.linkedin.com/in/jason-edward-salim-50751927a/" target="_blank">
                <FaLinkedin size={35} className="hover:fill-blue-600 fill-text hover:scale-125 transition-all" />
              </a>
            </div>
            <p className="mt-8">&copy; 2024 | Created by jsndwrd</p>
          </div>
        </section>
        <section id="mainContent" className=" bg-primary basis-2/3 pb-4 pl-8 pr-2"></section>
      </main>
    </div>
  );
}
